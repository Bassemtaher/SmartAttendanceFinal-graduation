...
public class DrLogin extends AppCompatActivity implements GetDataInterface{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login=findViewById(R.id.Drlogin);
        name=findViewById(R.id.drName);
        pass=findViewById(R.id.drPass);
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(checkIfAllMandatoryFieldsEntered()) {
                     ...
                     HelperMethods.getData(DrLogin.this, "Student", "please wait ", "loading");
    ...
    public void updateUI(DataSnapshot data) {
        ...
        if (isExist){
            Intent i= new Intent(DrLogin.this,DrForm.class);
            startActivity(i);
