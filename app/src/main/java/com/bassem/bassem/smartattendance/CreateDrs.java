...
public class CreateDrs extends AppCompatActivity implements AddInterface{
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (checkIfAllMandatoryFieldsEntered()) {
                    ...
                    HelperMethods.pushInFireBase("Student", HelperMethods.currentUser, CreateDrs.this, "loading", "plz wait", id);
    ...
    public void updateUI(DatabaseError databaseError)
    {
        if(databaseError==null){
            ...
            Intent i=new Intent(CreateDrs.this,studentService.class);
            startActivity(i);
        }
        else
        {
